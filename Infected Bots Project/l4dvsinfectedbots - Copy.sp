...
public OnPluginStart()
{
	...
	HookEvent("explain_elevator_button", ElevatorButton);
...
//Using built-in explaining events, we create a timer that fires an entity to get around the stuck bot problem, MI 5

public Action:ElevatorButton(Handle:event, const String:name[], bool:dontBroadcast)
{
LogMessage("[Infected bots] EVENT SUCCESSFULLY FIRED!");
CreateTimer(10.0, BotEnhancerTimer)
CreateTimer(11.0, CheatReseter)
BotEnhancer = true
}

public Action:TrainButton(Handle:event, const String:name[], bool:dontBroadcast)
{
LogMessage("[Infected bots] EVENT SUCCESSFULLY FIRED!");
CreateTimer(10.0, BotEnhancerTimer)
CreateTimer(11.0, CheatReseter)
