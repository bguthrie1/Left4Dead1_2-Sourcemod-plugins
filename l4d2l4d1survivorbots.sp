...
#define BILL 		GetEntProp(client, Prop_Send, "m_survivorCharacter") == 4
...
public Action:Timer_BillFix(Handle:timer)
{
	// This timer prevents Bill from crashing the game by switching to a generic survivor netprop every .5 seconds
