...
public Plugin:myinfo = 
{
	...
	author 			= "SwiftReal",
	description 	= "Allows additional players in coop mode",
...
{	
	...
	// Register cvars
	hMaxSurvivors	= CreateConVar("l4d_multislots_max_survivors", "10", "How many survivors allowed?", CVAR_FLAGS, true, 4.0, true, 20.0)
	hMaxInfected	= CreateConVar("l4d_multislots_max_infected", "10", "How many infected allowed?", CVAR_FLAGS, true, 4.0, true, 20.0)
...
stock TweakSettings()
{
	...
	SetConVarBounds(hMaxSurvivorsLimitCvar, ConVarBound_Upper, true, 20.0)
	...
	SetConVarBounds(hMaxInfectedLimitCvar, ConVarBound_Upper, true, 20.0)
