...
* 
* Version 2.4a/2.4b
* 		- May fix Bill from crashing, else try the a version
*
* Version 2.3b
...
#define GET_BILL_ALT_NETPROP 		GetEntProp(client, Prop_Send, "m_survivorCharacter") == 9
#define SET_CHARACTER_BILL_ALT			SetEntProp(client, Prop_Send, "m_survivorCharacter", 9);

#define GET_GENERIC_NETPROP		GetEntProp(client, Prop_Send, "m_survivorCharacter") == 9
